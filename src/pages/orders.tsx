          ...
          <Table className="mt-[80px] border-separate rounded-[8px] border-spacing-0 overflow-hidden border border-solid border-neutral-border inventory-table">
            ...
            <TableBody className="border-collapse">
              {table.getRowModel().rows.length > 0 ? (
                ...
                <TableRow className="h-[84px] bg-neutral-alt p-[16px] text-[16px] leading-[30px] text-text-primary">
                  <TableCell colSpan={7} className="text-center">
                    <div className="w-full flex items-center flex-col gap-2">
                      <div className="w-full h-16 bg-neutral-border animate-pulse rounded" />
                      <div className="w-full h-16 bg-neutral-border animate-pulse rounded" />
                      <div className="w-full h-16 bg-neutral-border animate-pulse rounded" />
                      <div className="w-full h-16 bg-neutral-border animate-pulse rounded" />
                      <div className="w-full h-16 bg-neutral-border animate-pulse rounded" />
                    ...
                    <div className="w-full h-[400px] flex items-center justify-center">
                      <div className="flex flex-col items-center gap-6">
                        ...
                        <p className="text-center">
                          No orders yet, but don't worry—soon <br /> they’ll
                          start rolling in. Stay tuned!
                        </p>
                      </div>
                    </div>
                  </TableCell>
              ...
              {table.getRowModel().rows.length > 0 ? (
                <>
                  {table.getRowModel().rows.map((row) => (
                    <TableRow
                      key={row.id}
                      className="box-border bg-neutral-alt"
                    >
                      {row.getVisibleCells().map((cell) => (
                        <TableCell
                ...
                <TableRow className="h-[84px] bg-neutral-alt p-[16px] text-[16px] leading-[30px] text-text-primary">
                  <TableCell colSpan={7} className="text-center">
                    <div className="w-full flex items-center flex-col gap-2">
                      <div className="w-full h-5 bg-neutral-border animate-pulse rounded" />
                      <div className="w-full h-5 bg-neutral-border animate-pulse rounded" />
                      <div className="w-full h-5 bg-neutral-border animate-pulse rounded" />
                      <div className="w-full h-5 bg-neutral-border animate-pulse rounded" />
                    </div>
