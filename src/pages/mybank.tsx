    ...
    <>
      ...
      <section className="w-full h-screen pt-[1rem] px-[5%]">
        <div className="flex flex-col gap-[4px] mb-5">
          ...
          <p className="text-[1rem] w-[512px] leading-[22.4px] font-[500] text-[#5c636d]">
            Add both Paystack and Bank Transfers to give buyers option to choose
            and prevent payment delays
          </p>
        </div>
        <div className="lg:w-[649px] rounded-[8px] flex justify-between p-5 items-center bg-[#FDFBFF] mb-[32px]">
          <div className="lg:w-[383px] flex flex-col gap-[16px]">
            <h2 className="font-[500] text-[1rem] text-[5c636d]">
              Select your preferred currency to receive payment
            </h2>
            <div className="w-[244px] h-[30px] flex items-center gap-[16px]">
              <img src={Nigeria} alt="" className="w-[32px] h-[15.93px]" />
              <p className="text-[20px] leading-[30px] font-[500] text-[#24272E]">
                Nigerian Naira (NGN)
              </p>
            </div>
          </div>
