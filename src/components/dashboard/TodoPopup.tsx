    ...
    return (
        <div className="fixed inset-0 bg-[#000000CC] flex items-center justify-center z-50">
            ...
            <div className="w-[772px] h-[560px] flex flex-col gap-[48px]">
                ...
                <div className="">
                    <h2 className="text-[32px] font-semibold leading-[35.2px] tracking-[-1%] text-[#24272E]">Update Schedule</h2>
                </div>

                <form className="space-y-4 w-[772px] h-[354px] flex flex-col gap-[16px]">
                    <div>
                        <label className="block text-[20px] font-medium text-[#24272E]">Task Title <span className="text-red-500">*</span></label>
                        <input className="w-full border bg-transparent border-[#CDCED3] rounded-[8px] p-[16px] mt-2" placeholder="Enter title" />
                    </div>
                        <div className="w-full h-[102px] flex flex-col gap-[16px]">
                        <label className="block text-[20px] font-medium text-[#24272E]">Details (Optional) <span className="text-red-500">*</span></label>
                            <input type="text" className="w-full h-[56px] border border-gray-300 rounded-[8px] p-[16px]" placeholder="Write..." />
                        </div>

                    <div className="w-full flex gap-[32px] items-center">

                        <div className="w-[370px] h-[102px] ">
                            <label className="block text-[20px] font-medium text-[#24272E]">Due Date <span className="text-red-500">*</span></label>
                            <input 
                                type="date" 
                        ...
                        <div className="h-[102px] w-[370px]">
                        <label className="block text-[20px] font-medium text-[#24272E]">Select time <span className="text-red-500">*</span></label>
                    ...
                    <div>
                        <label className="block text-[20px] font-medium text-[#24272E] mb-1">Reminder <span className="text-red-500">*</span></label>
                        <p className="mb-3 text-[0.87rem] text-[#5C636D]">Get notified before the deadline to stay on track</p>
